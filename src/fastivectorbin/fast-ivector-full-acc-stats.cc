...
int main(int argc, char *argv[]) {
  ...
  try {
      ...
      "Usage:  fast-ivector-full-est [options] <feats-rspecifier> <post-rspecifier>\n"
      "        <post-dim> <stats-N-wspecifier> <stats-F-wspecifier> <stats-wxfilename>\n"
      "e.g.: fast-ivector-full-acc-stats --ivec-dim 200 scp:feats.scp ark:post.ark\n"
    ...
    FastIvectorFullStats fast_ivec_full_stats(num_gauss,feat_dim,stats_N_wspecifier,
                                              stats_F_wspecifier);
