// fastivectorbin/fast-ivector-diag-randsvd-get-q.cc
...
int main(int argc, char *argv[]) {
  ...
  try {
      ...
      "Usage:  fast-ivector-diag-randsvd-get-q [options] <mat-rxfilename> <mat-wxfilename> \n"
      "e.g.: fast-ivector-diag-randsvd-get-q  Y.mat Q.mat\n";
