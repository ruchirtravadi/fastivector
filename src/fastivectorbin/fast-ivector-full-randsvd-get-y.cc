...
int main(int argc, char *argv[]) {
  ...
  try {
      ...
      "Usage:  fast-ivector-full-randsvd-get-y [options] <NS-stats-rxfilename> <F-stats-rspecifier> <mat-wxfilename> \n"
      "e.g.: fast-ivector-full-randsvd-get-y  stats_NS ark:stats_F.1 Y.1\n";
