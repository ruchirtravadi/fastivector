...
if [ $# != 3 ]; then
  ...
  echo " e.g.: $0 exp/fast_ivec_mdl/stats exp/fast_ivec_mdl/ubm/final.ubm exp/fast_ivec_mdl"
  exit 1;
fi
...
if [ $stage -le 1 ]; then
  ...
  fast-ivector-full-combine-stats $stats_dir/stats_NS.* $stats_dir/NS.stats
